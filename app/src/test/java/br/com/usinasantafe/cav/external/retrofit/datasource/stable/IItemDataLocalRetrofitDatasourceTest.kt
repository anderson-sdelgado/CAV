...
class IItemDataLocalRetrofitDatasourceTest {
    ...
    fun `Check return failure if token is invalid`() =
        runTest {
            ...
            val service = retrofit.create(ItemDataLocalApi::class.java)
            val datasource = IItemDataLocalRetrofitDatasource(service)
