...
class IUpdateTableOptionDataLocalTest {
    ...
    private val usecase = IUpdateTableOptionDataLocal(
        getToken = getToken,
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableOptionDataLocal -> GetToken -> java.lang.Exception",
                    currentProgress = 1f,
                )
            )
        }
    ...
    fun `Check return failure if have error in ColabRepository recoverAll`() =
        runTest {
            ...
            whenever(
                dataLocalRepository.listAllOption("token")
            ).thenReturn(
                resultFailure(
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableOptionDataLocal -> IDataLocalRepository.recoverAll -> java.lang.Exception",
                    currentProgress = 1f,
                )
            )
        }
    ...
    fun `Check return failure if have error in ColabRepository deleteAll`() =
        runTest {
            ...
            whenever(
                dataLocalRepository.deleteAllOption()
            ).thenReturn(
                resultFailure(
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableOptionDataLocal -> IDataLocalRepository.deleteAll -> java.lang.Exception",
                    currentProgress = 1f,
                )
            )
        }
    ...
    fun `Check return failure if have error in ColabRepository addAll`() =
        runTest {
            ...
            whenever(
                dataLocalRepository.addAllOption(list)
            ).thenReturn(
                resultFailure(
            ...
            val resultList = result.toList()
            verify(dataLocalRepository, atLeastOnce()).deleteAllOption()
            assertEquals(
                result.count(),
                4
            )
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableOptionDataLocal -> IDataLocalRepository.addAll -> java.lang.Exception",
                    currentProgress = 1f,
                )
            )
        }
    ...
    fun `Check return correct if function execute successfully`() =
        runTest {
            ...
            val resultList = result.toList()
            verify(dataLocalRepository, atLeastOnce()).deleteAllOption()
            verify(dataLocalRepository, atLeastOnce()).addAllOption(list)
            assertEquals(
                result.count(),
                3
            )
