...
class IROptionItemDataLocalRetrofitDatasourceTest {
    ...
    fun `Check return failure if token is invalid`() =
        runTest {
            ...
            val service = retrofit.create(ROptionItemDataLocalApi::class.java)
            val datasource = IROptionItemDataLocalRetrofitDatasource(service)
            ...
            assertEquals(
                "IROptionItemDataLocalRetrofitDatasource.listAll",
