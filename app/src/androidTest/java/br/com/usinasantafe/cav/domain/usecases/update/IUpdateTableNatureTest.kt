...
class IUpdateTableNatureTest {
    ...
    @Inject
    lateinit var usecase: UpdateTableNature
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNature -> IGetToken -> IConfigRepository.get -> number is required",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNature -> INatureRepository.listAll -> INatureRetrofitDatasource.listAll -> java.net.ConnectException: Failed to connect to localhost/127.0.0.1:8080",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNature -> INatureRepository.listAll -> INatureRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNature -> INatureRepository.listAll -> INatureRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNature -> INatureRepository.addAll -> INatureRoomDatasource.addAll -> android.database.sqlite.SQLiteConstraintException: UNIQUE constraint failed: tb_nature.id (code 1555 SQLITE_CONSTRAINT_PRIMARYKEY[1555])",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
