...
class IUpdateTableSupportTeamsTest {
    ...
    @Inject
    lateinit var usecase: UpdateTableSupportTeams
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableSupportTeams -> IGetToken -> IConfigRepository.get -> number is required",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableSupportTeams -> ISupportTeamsRepository.listAll -> ISupportTeamsRetrofitDatasource.listAll -> java.net.ConnectException: Failed to connect to localhost/127.0.0.1:8080",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableSupportTeams -> ISupportTeamsRepository.listAll -> ISupportTeamsRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableSupportTeams -> ISupportTeamsRepository.listAll -> ISupportTeamsRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableSupportTeams -> ISupportTeamsRepository.addAll -> ISupportTeamsRoomDatasource.addAll -> android.database.sqlite.SQLiteConstraintException: UNIQUE constraint failed: tb_support_teams.id (code 1555 SQLITE_CONSTRAINT_PRIMARYKEY[1555])",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
    ...
    fun verify_return_data_if_success_usecase() =
        runTest {
            ...
            val modelList = supportTeamsDao.all()
            assertEquals(
                modelList.size,
                2
            )
