        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableROptionItemDataLocal -> IGetToken -> IConfigRepository.get -> number is required",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableROptionItemDataLocal -> IDataLocalRepository.listAllROptionItem -> IROptionItemDataLocalRetrofitDatasource.listAll -> java.net.ConnectException: Failed to connect to localhost/127.0.0.1:8080",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableROptionItemDataLocal -> IDataLocalRepository.listAllROptionItem -> IROptionItemDataLocalRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableROptionItemDataLocal -> IDataLocalRepository.listAllROptionItem -> IROptionItemDataLocalRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableROptionItemDataLocal -> IDataLocalRepository.addAllROptionItem -> IROptionItemDataLocalRoomDatasource.addAll -> android.database.sqlite.SQLiteConstraintException: UNIQUE constraint failed: tb_r_option_item_data_local.id (code 1555 SQLITE_CONSTRAINT_PRIMARYKEY[1555])",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
