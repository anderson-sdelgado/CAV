package br.com.usinasantafe.cav.integration.involved
...
class EditFlowTest {
    ...
    fun flow() =
        runTest(
            ...
            composeTestRule.onNodeWithTag(TAG_INVOLVED_FULL_INSERT_BUTTON)
                .performClick()
            ...
            composeTestRule.onNodeWithTag("${TAG_INVOLVED_FULL_EDIT_BUTTON}1")
                .performClick()
