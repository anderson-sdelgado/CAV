package br.com.usinasantafe.cav.integration.involvedExternal
...
import br.com.usinasantafe.cav.presenter.view.card.external.address.TAG_ADDRESS_INVOLVED_TEXT_FIELD
import br.com.usinasantafe.cav.presenter.view.card.external.data.TAG_ADDRESS_DATA_INVOLVED_EDIT_BUTTON
import br.com.usinasantafe.cav.presenter.view.card.external.data.TAG_DETAIL_DATA_INVOLVED_EDIT_BUTTON
import br.com.usinasantafe.cav.presenter.view.card.external.data.TAG_DOCUMENT_DATA_INVOLVED_EDIT_BUTTON
import br.com.usinasantafe.cav.presenter.view.card.external.data.TAG_NAME_DATA_INVOLVED_EDIT_BUTTON
import br.com.usinasantafe.cav.presenter.view.card.external.data.TAG_PHONE_DATA_INVOLVED_EDIT_BUTTON
import br.com.usinasantafe.cav.presenter.view.card.external.data.TAG_STATE_DATA_INVOLVED_EDIT_BUTTON
import br.com.usinasantafe.cav.presenter.view.card.external.name.TAG_NAME_INVOLVED_TEXT_FIELD
import br.com.usinasantafe.cav.presenter.view.card.menu.TAG_INVOLVED_EXTERNAL_FULL_EDIT_BUTTON
import br.com.usinasantafe.cav.presenter.view.card.menu.TAG_INVOLVED_EXTERNAL_FULL_INSERT_BUTTON
...
class EditFlowTest {
    ...
    fun flow() =
        runTest(
            ...
            composeTestRule.onNodeWithTag(TAG_ADDRESS_INVOLVED_TEXT_FIELD)
