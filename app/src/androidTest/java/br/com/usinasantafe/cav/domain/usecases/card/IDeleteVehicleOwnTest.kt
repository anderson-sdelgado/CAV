...
class IDeleteVehicleOwnTest {
    ...
    @Inject
    lateinit var usecase: DeleteVehicleOwn
    ...
    @Test
    fun check_delete_vehicle_own() = runTest {
        val data = CardSharedPreferencesModel(
            vehicleOwnList = listOf(
                VehicleOwnSharedPreferencesModel(id = 1)
            )
        )
        ...
        assertEquals(modelAfter.vehicleOwnList.size, 0)
    }
}
