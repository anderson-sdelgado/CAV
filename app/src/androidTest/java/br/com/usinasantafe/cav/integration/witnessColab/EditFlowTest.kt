...
import br.com.usinasantafe.cav.presenter.view.card.menu.TAG_WITNESS_COLAB_FULL_EDIT_BUTTON
...
class EditFlowTest {
    ...
    fun flow() =
        runTest(
            ...
            composeTestRule.onNodeWithTag("${TAG_WITNESS_COLAB_FULL_EDIT_BUTTON}1")
                .performClick()
