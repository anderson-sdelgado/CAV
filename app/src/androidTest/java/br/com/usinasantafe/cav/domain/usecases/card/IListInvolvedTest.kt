...
@HiltAndroidTest
class IListInvolvedTest {

    @get:Rule
    val hiltRule = HiltAndroidRule(this)

    @Inject
    lateinit var usecase: ListInvolved
    ...
    fun check_list_involved() = runTest {
        val data = CardSharedPreferencesModel(
            involvedList = listOf(
                InvolvedSharedPreferencesModel(id = 1, document = "123", name = "I1"),
                InvolvedSharedPreferencesModel(id = 2, document = "456", name = "I2")
            )
        )
