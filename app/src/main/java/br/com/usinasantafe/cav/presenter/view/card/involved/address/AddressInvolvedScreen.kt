...
@Composable
fun AddressInvolvedScreen(
    viewModel: AddressInvolvedViewModel = hiltViewModel(),
    onNavPhone: () -> Unit,
    onNavDetail: () -> Unit,
) {
    CAVTheme {
...
fun AddressInvolvedContent(
    ...
    Column(
        ...
        TitleDesign(
            text = stringResource(
                id = R.string.text_title_address
            )
        )
...
@Composable
fun AddressInvolvedPagePreview() {
    CAVTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            AddressInvolvedContent(
                text = "Text",
