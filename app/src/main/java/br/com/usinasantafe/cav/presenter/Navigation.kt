...
object Routes {
    ...
    const val PASSENGER_LIST_ROUTE = "$PASSENGER_LIST_SCREEN/{$FLOW_NOTE_ARG}/{$ID_MAIN_ARG}"
    const val STATE_ROUTE = "$STATE_SCREEN/{$OPTION_ARG}/{$FLOW_NOTE_ARG}/{$ID_MAIN_ARG}/{$ID_SECONDARY_ARG}"
    const val DATA_EQUIP_ROUTE = "$DATA_EQUIP_SCREEN/{$FLOW_NOTE_ARG}/{$ID_MAIN_ARG}/{$ID_SECONDARY_ARG}"
    const val DATA_COLAB_ROUTE = "$DATA_COLAB_SCREEN/{$FLOW_NOTE_ARG}/{$ID_MAIN_ARG}/{$ID_SECONDARY_ARG}"
