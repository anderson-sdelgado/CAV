...
fun InvolvedDataContent(
    ...
    Column(
        ...
        TitleDesign(
            text = stringResource(
                id = when(flowNote) {
                    ...
                    FlowNote.INVOLVED_EXTERNAL -> R.string.text_data_involved
                    FlowNote.WITNESS_EXTERNAL -> R.string.text_data_witness
        ...
        LazyColumn(
            ...
            if(flowNote != FlowNote.WITNESS_EXTERNAL) {
                item {
        ...
        ButtonMaxWidth(R.string.text_pattern_return) {
            when(flowNote) {
                ...
                FlowNote.PASSENGER_EXTERNAL -> onNavPassengerList()
                else -> onNavMenu()
            }
        }
        BackHandler {}
