...
@Composable
fun VehicleInvolvedDataContent(
    vehicle: String,
    driver: String,
    passengers: String,
    onCloseDialog: () -> Unit,
    ...
    Column(
        ...
        TitleDesign(
            text = stringResource(
                id = R.string.text_title_data_vehicle_foreign
            )
        )
        LazyColumn(
            ...
            item {
                Row(
                    ...
                    Button(
                        onClick = onNavPlate,
                        Modifier
                            .testTag(TAG_VEHICLE_FOREIGN_EDIT_BUTTON)
                    ) {
                        Text(
                            text = stringResource(
            ...
            item {
                Row(
                    ...
                    Button(
                        ...
                        Modifier
                            .testTag(TAG_DRIVER_FOREIGN_EDIT_BUTTON)
                    ) {
                        Text(
                            text = stringResource(
                                id = R.string.text_pattern_edit
            ...
            item {
                Row(
                    ...
                    Button(
                        ...
                        Modifier
                            .testTag(TAG_PASSENGERS_FOREIGN_EDIT_BUTTON)
                    ) {
                        Text(
                            text = stringResource(
                                id = R.string.text_pattern_edit
...
@Composable
fun VehicleInvolvedDataPagePreview() {
    CAVTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            VehicleInvolvedDataContent(
                vehicle = "ABC1234 - GOL",
