...
@Composable
fun PassengerListOwnScreen(
    viewModel: PassengerListOwnViewModel = hiltViewModel(),
    onNavDetail: () -> Unit,
    onNavMenu: () -> Unit,
    onNavData: () -> Unit,
    onNavColab: (Int) -> Unit
...
@Composable
fun PassengerListOwnPagePreview() {
    CAVTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            PassengerListOwnContent(
