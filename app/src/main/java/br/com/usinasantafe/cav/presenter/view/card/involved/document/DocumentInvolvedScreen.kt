...
@Composable
fun DocumentInvolvedScreen(
    viewModel: DocumentInvolvedViewModel = hiltViewModel(),
    onNavDetail: () -> Unit,
    onNavData: () -> Unit,
...
@Composable
fun DocumentInvolvedPagePreview() {
    CAVTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            DocumentInvolvedContent(
